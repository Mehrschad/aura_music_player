...
The search script is installed with this skill at `.claude/skills/ui-ux-pro-max/scripts/search.py`. Invoke it by that path from the project root — do not assume a different working directory:
